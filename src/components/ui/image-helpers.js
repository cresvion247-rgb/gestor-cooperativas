/**
 * Legacy Base44 / Wix CDN hosts only. Supabase Storage public URLs and any
 * other non-Wix host are passed through unchanged (parseWixMediaUrl → null →
 * plain <img src>). Do not route incidencias-fotos or other Storage URLs here.
 */
